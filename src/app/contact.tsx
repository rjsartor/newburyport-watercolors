...
export const Contact = () => {
  return (
    <section id='contact' className='content-section flex-col mb-24 sm:mb-48'>
       <h2 className='m-12 text-3xl sm:text-5xl'>Contact</h2>
      {/* <div className='flex flex-wrap justify-center gap-8 sm:gap-24'> */}
        ...
        <div className="max-w-xlg flex flex-col justify-center">
          ...
          <Spacer height={3} />
          <p>
            For any enquiries or questions, email me at <b className="underline">{' '}<a href="mailto:brucewarlington@gmail.com?subject=Artwork Inquiry&body=Hi Bruce, " target="_blank" rel="noopener noreferrer" aria-label='email'>brucewarlington@gmail.com.</a></b>
          </p>
          <Spacer height={2} />
